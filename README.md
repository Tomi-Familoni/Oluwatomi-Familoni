...
- `Kindly note that the tests were implemented with the assumption that the API would be run locally. To run the API locally, kindly follow the instructions laid out here before running tests:` https://github.com/swagger-api/swagger-petstore
